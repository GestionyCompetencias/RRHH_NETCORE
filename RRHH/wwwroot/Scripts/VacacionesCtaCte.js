...
$(function () {
    ...
    $(document).on("click", "#btn-filter", function (e) {
        ...
        var rut = document.getElementById("cbo_persona").value;
        var des = document.getElementById("txt_desde").value;
        var has = document.getElementById("txt_hasta").value;
        const dest = `ListarVacacionesCtaCte?rut=${rut}&desde=${des}&hasta=${has}`;
            ...
            $.get(dest, (resp) => {
                ...
                if (libro !== null) {
                    ...
                    const cabeceras = ['Rut', 'Nombre', 'Periodo','Uso','Desde', 'hasta', 'dias'];
                    ...
                    document.getElementById("list_vacacionesctacte").innerHTML = '';
                    ...
                    $("#list_vacacionesctacte").html(msg);
                }
...
const cargarTabla = (cabeceras, data) => {
    ...
    data.forEach(lib => {
        ...
        lib.forEach(itLib => {
            ...
            contenido += `<td class="text-right" align="right">${itLib.periodo}</td>`;
            contenido += `<td class="text-right" align="right">${itLib.tipouso}</td>`;
        ...
        contenido += `<td class="bg-light" colspan="6">Totales... </td>`;
    ...
    $("#list_vacacionesctacte").html(contenido);
}
...
const cargarTablaImpresion = (cabeceras, data) => {
    ...
    $("#title-impresion").html(`Consulta cuenta corriente de vacaciones `);
