...
$(function () {
    ...
    $(document).on("click", "#btn-filter", function (e) {
        ...
        const dest = `ListarVacacionesPersonal?desde=${des}&hasta=${has}`;
            ...
            $.get(dest, (resp) => {
                ...
                if (libro !== null) {
                    ...
                    const cabeceras = ['Rut', 'Nombre', 'Desde', 'hasta', 'dias'];
                    ...
                    document.getElementById("list_vacacionespersonal").innerHTML = '';
                    ...
                    $("#list_vacacionespersonal").html(msg);
                }
    ...
    $(document).on("click", "#export", function () {
        $("#table-libroZ").table2excel({
            filename: "PersonalEnVacaciones.xls",
        })
    });
...
const cargarTabla = (cabeceras, data) => {
    ...
    data.forEach(lib => {
        ...
        contenido += `<td class="bg-light" colspan="4">Totales... </td>`;
    ...
    $("#list_vacacionespersonal").html(contenido);
}
...
const cargarTablaImpresion = (cabeceras, data) => {
    ...
    $("#title-impresion").html(`Consulta de personal en vacaciones desde ${desde} hasta ${hasta}`);
